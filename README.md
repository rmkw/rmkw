...
🔭 Actualmente trabajo en el INEGI como **Enlace de Vinculación Geográfica "C"**, desarrollando sistemas para la gestión y análisis de información estadística, integrando automatización con Python y capacidades de IA como **OCR, búsqueda semántica, embeddings y flujos inteligentes**.
